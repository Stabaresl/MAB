...
export default async function NosotrosPage() {
  ...
  return (
    <div className="page py-14 md:py-20">
      ...
      <section className="grid gap-px overflow-hidden rounded-lg border border-hairline bg-hairline mt-12 md:grid-cols-2">
        <div className="bg-surface-1 p-8">
          <h2 className="label text-accent-text">Misión</h2>
          <p className="mt-4 text-[17px] leading-relaxed text-ink-muted">{site.mission}</p>
        </div>
        <div className="bg-surface-1 p-8">
          <h2 className="label text-accent-text">Visión</h2>
          <p className="mt-4 text-[17px] leading-relaxed text-ink-muted">{site.vision}</p>
        </div>
      </section>

      <section className="mt-20 grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:items-center lg:gap-16">
        <div>
          <p className="label text-accent-text">Calidad certificada</p>
          <h2 className="mt-3 text-[clamp(1.6rem,4vw,2.4rem)] leading-tight text-ink">
            Piezas que cumplen la norma
          </h2>
          <p className="mt-6 max-w-[58ch] text-ink-muted">
      ...
      <section className="mt-20 border-t border-hairline pt-12">
        <p className="label text-accent-text">Logística y entrega</p>
      ...
      <section className="mt-20 border-t border-hairline pt-12">
        ...
        <ul className="mt-8 grid gap-x-8 gap-y-px border-t border-hairline sm:grid-cols-2 lg:grid-cols-3">
